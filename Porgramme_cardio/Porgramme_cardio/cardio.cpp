...
void affichage(){                           //Fonction de l'affichage des valeurs
  if(time > condition){                     //Deuxième fonction, le temps doit être supérieur à la condition afin de pouvoir accéder au lignes suivantes
      Compteur = Compteur*30;                //A la fin de l'incrémentation on multiplie par 6 afin d'avoir les battements par minutes
      ...
      condition = condition + 2000;        //On augmente la condition de 10 000 afin de pouvoir rentrer dans la boucle toutes les 10s
